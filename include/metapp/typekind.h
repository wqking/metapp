...
constexpr TypeKind tkOverloadedFunction = 37;
constexpr TypeKind tkDefaultArgsFunction = 38;
constexpr TypeKind tkVariadicFunction = 39;
constexpr TypeKind tkArray = 40;
constexpr TypeKind tkEnum = 41;
constexpr TypeKind tkAccessor = 42;
constexpr TypeKind tkVariant = 43; // metapp::Variant
constexpr TypeKind tkMetaType = 44; // metapp::MetaType
constexpr TypeKind tkMetaRepo = 45; // metapp::MetaRepo
