...
constexpr TypeKind tkStdFunction = 104;
constexpr TypeKind tkStdVector = 105;
constexpr TypeKind tkStdList = 106;
constexpr TypeKind tkStdDeque = 107;
constexpr TypeKind tkStdArray = 108;
constexpr TypeKind tkStdForwardList = 109;
constexpr TypeKind tkStdStack = 110;
constexpr TypeKind tkStdQueue = 111;
constexpr TypeKind tkStdPriorityQueue = 112;
constexpr TypeKind tkStdMap = 113;
constexpr TypeKind tkStdMultimap = 114;
constexpr TypeKind tkStdSet = 115;
constexpr TypeKind tkStdMultiset = 116;
constexpr TypeKind tkStdUnorderedMap = 117;
constexpr TypeKind tkStdUnorderedMultimap = 118;
constexpr TypeKind tkStdUnorderedSet = 119;
constexpr TypeKind tkStdUnorderedMultiset = 120;
constexpr TypeKind tkStdPair = 121;
constexpr TypeKind tkStdTuple = 122;
constexpr TypeKind tkStdAny = 123;
constexpr TypeKind tkStdVariant = 124;
