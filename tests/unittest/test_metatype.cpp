...
TEST_CASE("MetaType, compare")
{
	REQUIRE(metapp::getMetaType<int>()->compare(metapp::getMetaType<int>()) == 0);
	REQUIRE(metapp::getMetaType<int>()->compare(metapp::getMetaType<const int>()) == 0);
	
	REQUIRE(metapp::getMetaType<int *>()->compare(metapp::getMetaType<int * const>()) == 0);
	REQUIRE(metapp::getMetaType<int *>()->compare(metapp::getMetaType<const int *>()) == 0);
	REQUIRE(metapp::getMetaType<int const * volatile *>()->compare(metapp::getMetaType<int volatile * const *>()) == 0);

	REQUIRE(metapp::getMetaType<int *>()->compare(metapp::getMetaType<int ** const>()) != 0);
	REQUIRE(metapp::getMetaType<int *>()->compare(metapp::getMetaType<int ** const>())
		== -metapp::getMetaType<int ** const>()->compare(metapp::getMetaType<int *>())
	);
}
